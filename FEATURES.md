...
> Source of truth for the website, datasheets and sales decks. Updated for **v2.71** (2026-06-12).
...
- Current version channel: see `latest.json`. All claims in this file are shipped as of v2.71.
