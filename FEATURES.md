...
> Source of truth for the website, datasheets, sales decks and tutorial planning. Updated for **v3.20.1** (2026-07-28).
...
- Current version channel: see `latest.json`. All claims in this file are shipped as of v3.20.1.
