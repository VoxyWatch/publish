...
> Source of truth for the website, datasheets, sales decks and tutorial planning. Updated for **v2.151.6** (2026-06-29).
...
- Current version channel: see `latest.json`. All claims in this file are shipped as of v2.151.6.
