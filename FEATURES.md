...
> Source of truth for the website, datasheets and sales decks. Updated for **v2.89** (2026-06-17).
...
- Current version channel: see `latest.json`. All claims in this file are shipped as of v2.89.
